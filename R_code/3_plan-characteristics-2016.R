...
ma.path.a <- paste0("data/input/landscape/Extracted Data/2016LandscapeSource file MA_AtoM 04222016.csv")
...
ma.path.b <- paste0("data/input/landscape/Extracted Data/2016LandscapeSource file MA_NtoW 04222016.csv")
...
mapd.path.a <- paste0("data/input/landscape/Extracted Data/PartCD/2016/Medicare Part D 2016 Plan Report 04222016.xls")
...
mapd.path.b <- paste0("data/input/landscape/Extracted Data/PartCD/2016/Medicare Part D 2016 Plan Report 04222016.xls")
