...
ma.path.a <- paste0("data/input/landscape/Extracted Data/2011LandscapeSourceData_MA_12_17_10_AtoM.csv")
...
ma.path.b <- paste0("data/input/landscape/Extracted Data/2011LandscapeSourceData_MA_12_17_10_NtoW.csv")
...
mapd.path.a <- paste0("data/input/landscape/Extracted Data/PartCD/2011/Medicare Part D 2011 Plan Report 09-15-10.xls")
...
mapd.path.b <- paste0("data/input/landscape/Extracted Data/PartCD/2011/Medicare Part D 2011 Plan Report 09-15-10.xls")
