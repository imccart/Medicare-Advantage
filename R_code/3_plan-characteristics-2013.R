...
ma.path.a <- paste0("data/input/landscape/Extracted Data/2013LandscapeSource file MA_AtoM 11212012.csv")
...
ma.path.b <- paste0("data/input/landscape/Extracted Data/2013LandscapeSource file MA_NtoW 11212012.csv")
...
mapd.path.a <- paste0("data/input/landscape/Extracted Data/PartCD/2013/Medicare Part D 2013 Plan Report 04252013v1.xls")
...
mapd.path.b <- paste0("data/input/landscape/Extracted Data/PartCD/2013/Medicare Part D 2013 Plan Report 04252013v1.xls")
