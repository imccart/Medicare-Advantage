...
ma.path.a <- "data/input/ma/star-ratings/Extracted Star Ratings/2009/2009_Part_C_Report_Card_Master_Table_2009_11_30_stars.csv"
...
ma.path.b <- "data/input/ma/star-ratings/Extracted Star Ratings/2009/2009_Part_C_Report_Card_Master_Table_2009_11_30_summary.csv"
