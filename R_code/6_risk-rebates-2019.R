...
ma.path.a="data/input/cms-payment/2019/2019PartCPlanLevel.xlsx"
risk.rebate.a=read_xlsx(ma.path.a,range="A4:G3620",
                        col_names=c("contractid","planid","contract_name","plan_type",
                                    "riskscore_partc","payment_partc","rebate_partc"))
ma.path.b="data/input/cms-payment/2019/2019PartDPlans.xlsx"
risk.rebate.b=read_xlsx(ma.path.b,range="A4:H4460",
                        col_names=c("contractid","planid","contract_name","plan_type",
