...
ma.path.a <- "data/input/ma/cms-payment/2013/2013PartCPlan Level.xlsx"
risk.rebate.a <- read_xlsx(ma.path.a,range="A4:G2968",
                        col_names=c("contractid","planid","contract_name","plan_type",
                                    "riskscore_partc","payment_partc","rebate_partc"))
ma.path.b <- "data/input/ma/cms-payment/2013/2013PartDPlans.xlsx"
risk.rebate.b <- read_xlsx(ma.path.b,range="A4:H3836",
                        col_names=c("contractid","planid","contract_name","plan_type",
