...
ma.path.a <- "data/input/ma/cms-payment/2022/2022PartCPlanLevel.xlsx"
risk.rebate.a <- read_xlsx(ma.path.a,range="A4:G5125",sheet="result.html",
                        col_names=c("contractid","planid","contract_name","plan_type",
                                    "riskscore_partc","payment_partc","rebate_partc"))
ma.path.b <- "data/input/ma/cms-payment/2022/2022PartDPlans.xlsx"
risk.rebate.b <- read_xlsx(ma.path.b,range="A4:H5791",sheet="result.html",
                        col_names=c("contractid","planid","contract_name","plan_type",
