...
ma.path.a <- paste0("data/input/landscape/Extracted Data/2014LandscapeSource file MA_AtoM 05292014.csv")
...
ma.path.b <- paste0("data/input/landscape/Extracted Data/2014LandscapeSource file MA_NtoW 05292014.csv")
...
mapd.path.a <- paste0("data/input/landscape/Extracted Data/PartCD/2014/Medicare Part D 2014 Plan Report 05292014.xls")
...
mapd.path.b <- paste0("data/input/landscape/Extracted Data/PartCD/2014/Medicare Part D 2014 Plan Report 05292014.xls")
