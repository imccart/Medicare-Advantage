...
ma.path.a <- "data/input/ma/star-ratings/Extracted Star Ratings/2017 Fall/2017_Report_Card_Master_Table_2016_10_26_stars.csv"
star.data.a <- fread(
  ma.path.a,
  skip = 4,
...
ma.path.b <- "data/input/ma/star-ratings/Extracted Star Ratings/2017 Fall/2017_Report_Card_Master_Table_2016_10_26_summary.csv"
star.data.b <- fread(
  ma.path.b,
  skip = 2,
  stringsAsFactors=FALSE, 
