...
## 2009
ma.path.2009a=paste(path.data.ma,"\\CMS Payment Data\\2009\\2009PartCPlanLevel2.xlsx",sep="")
risk.rebate.2009a=read_xlsx(ma.path.2009a,range="A4:H3506",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc",
                                        "msa_deposit_partc"))

ma.path.2009b=paste(path.data.ma,"\\CMS Payment Data\\2009\\2009PartDPlans2.xlsx",sep="")
...
## 2010
ma.path.2010a=paste(path.data.ma,"\\CMS Payment Data\\2010\\2010PartCPlanLevel2.xlsx",sep="")
risk.rebate.2010a=read_xlsx(ma.path.2010a,range="A4:H3157",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc",
                                        "msa_deposit_partc"))

ma.path.2010b=paste(path.data.ma,"\\CMS Payment Data\\2010\\2010PartDPlans2.xlsx",sep="")
...
## 2011
ma.path.2011a=paste(path.data.ma,"\\CMS Payment Data\\2011\\2011PartCPlanLevel.xlsx",sep="")
risk.rebate.2011a=read_xlsx(ma.path.2011a,range="A4:H2663",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc",
                                        "msa_deposit_partc"))

ma.path.2011b=paste(path.data.ma,"\\CMS Payment Data\\2011\\2011PartDPlans.xlsx",sep="")
...
## 2012
ma.path.2012a=paste(path.data.ma,"\\CMS Payment Data\\2012\\2012PartCPlanLevel.xlsx",sep="")
risk.rebate.2012a=read_xlsx(ma.path.2012a,range="A4:H2757",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc",
                                        "msa_deposit_partc"))

ma.path.2012b=paste(path.data.ma,"\\CMS Payment Data\\2012\\2012PartDPlans.xlsx",sep="")
...
## 2013
ma.path.2013a=paste(path.data.ma,"\\CMS Payment Data\\2013\\2013PartCPlan Level.xlsx",sep="")
risk.rebate.2013a=read_xlsx(ma.path.2013a,range="A4:G2968",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc"))

ma.path.2013b=paste(path.data.ma,"\\CMS Payment Data\\2013\\2013PartDPlans.xlsx",sep="")
...
## 2014
ma.path.2014a=paste(path.data.ma,"\\CMS Payment Data\\2014\\2014PartCPlan Level.xlsx",sep="")
risk.rebate.2014a=read_xlsx(ma.path.2014a,range="A4:G2828",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc"))

ma.path.2014b=paste(path.data.ma,"\\CMS Payment Data\\2014\\2014PartDPlans.xlsx",sep="")
...
## 2015
ma.path.2015a=paste(path.data.ma,"\\CMS Payment Data\\2015\\2015PartCPlanLevel.xlsx",sep="")
risk.rebate.2015a=read_xlsx(ma.path.2015a,range="A4:G2745",
                            col_names=c("contractid","planid","contract_name","plan_type",
                                        "riskscore_partc","payment_partc","rebate_partc"))

ma.path.2015b=paste(path.data.ma,"\\CMS Payment Data\\2015\\2015PartDPlans.xlsx",sep="")
