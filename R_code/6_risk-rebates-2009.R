...
ma.path.a <- "data/input/ma/cms-payment/2009/2009PartCPlanLevel2.xlsx"
risk.rebate.a=read_xlsx(ma.path.a,range="A4:H3506",
                        col_names=c("contractid","planid","contract_name","plan_type",
                                    "riskscore_partc","payment_partc","rebate_partc",
                                    "msa_deposit_partc"))
ma.path.b <- "data/input/ma/cms-payment/2009/2009PartDPlans2.xlsx"
risk.rebate.b=read_xlsx(ma.path.b,range="A4:H4733",
                        col_names=c("contractid","planid","contract_name","plan_type",
