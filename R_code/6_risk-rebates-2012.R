...
ma.path.a <- "data/input/ma/cms-payment/2012/2012PartCPlanLevel.xlsx"
risk.rebate.a <- read_xlsx(ma.path.a,range="A4:H2757",
                        col_names=c("contractid","planid","contract_name","plan_type",
                                    "riskscore_partc","payment_partc","rebate_partc",
                                    "msa_deposit_partc"))
ma.path.b <- "data/input/ma/cms-payment/2012/2012PartDPlans.xlsx"
risk.rebate.b <- read_xlsx(ma.path.b,range="A4:H3605",
                        col_names=c("contractid","planid","contract_name","plan_type",
