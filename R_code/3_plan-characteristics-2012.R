...
ma.path.a <- paste0("data/input/ma/landscape/Extracted Data/2012LandscapeSourceData_MA_3_08_12_AtoM.csv")
...
ma.path.b <- paste0("data/input/ma/landscape/Extracted Data/2012LandscapeSourceData_MA_3_08_12_NtoW.csv")
...
mapd.path.a <- paste0("data/input/ma/landscape/Extracted Data/PartCD/2012/Medicare Part D 2012 Plan Report 09-08-11.xls")
...
mapd.path.b <- paste0("data/input/ma/landscape/Extracted Data/PartCD/2012/Medicare Part D 2012 Plan Report 09-08-11.xls")
