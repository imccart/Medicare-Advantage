...
ma.path.a <- paste0("data/input/landscape/Extracted Data/2010LandscapeSourceData_MA_12_01_09_A_to_M.csv")
...
ma.path.b <- paste0("data/input/landscape/Extracted Data/2010LandscapeSourceData_MA_12_01_09_N_to_W.csv")
...
mapd.path.a <- paste0("data/input/landscape/Extracted Data/PartCD/2010/Medicare Part D 2010 Plan Report 09-14-09.xls")
...
mapd.path.b <- paste0("data/input/landscape/Extracted Data/PartCD/2010/Medicare Part D 2010 Plan Report 09-14-09.xls")
