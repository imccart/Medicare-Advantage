...
ma.path.a <- "data/input/ma/star-ratings/Extracted Star Ratings/2018 Fall/2018_Report_Card_Master_Table_2017_11_01_stars.csv"
star.data.a <- fread(
  ma.path.a,
  skip = 4,
  stringsAsFactors=FALSE,
  select=c(1:39),
  col.names=rating.vars.2018,
  na = c("", "NA", "*")
) %>%
  mutate(across(
...
ma.path.b <- "data/input/ma/star-ratings/Extracted Star Ratings/2018 Fall/2018_Report_Card_Master_Table_2017_11_01_summary.csv"
star.data.b <- fread(
  ma.path.b,
  skip = 2,
  stringsAsFactors=FALSE, 
