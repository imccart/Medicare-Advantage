...
ma.path.a <- paste0("data/input/ma/landscape/Extracted Data/2022LandscapeSource file MA_AtoM 10262021.csv")
...
ma.path.b <- paste0("data/input/ma/landscape/Extracted Data/2022LandscapeSource file MA_NtoW 10262021.csv")
...
mapd.path.a <- paste0("data/input/ma/landscape/Extracted Data/PartCD/2022/Medicare Part D 2022 Plan Report 10262021.xls")
...
mapd.path.b <- paste0("data/input/ma/landscape/Extracted Data/PartCD/2022/Medicare Part D 2022 Plan Report 10262021.xls")
