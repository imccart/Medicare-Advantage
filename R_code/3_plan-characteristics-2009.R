...
ma.path.a <- paste0("data/input/ma/landscape/Extracted Data/2009LandscapeSourceData_MA_11_05_08_A_to_M.csv")
...
ma.path.b <- paste0("data/input/ma/landscape/Extracted Data/2009LandscapeSourceData_MA_11_05_08_N_to_W.csv")
...
mapd.path.a <- paste0("data/input/ma/landscape/Extracted Data/PartCD/2009/Medicare Part D 2009 Plan Report 11-03-08.xls")
...
mapd.path.b <- paste0("data/input/ma/landscape/Extracted Data/PartCD/2009/Medicare Part D 2009 Plan Report 11-03-08.xls")
