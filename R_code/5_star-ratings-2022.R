...
ma.path.a <- "data/input/ma/star-ratings/Extracted Star Ratings/2022/2022 Star Ratings Data Table - Measure Stars (Oct 06 2021).csv"
star.data.a <- fread(
  ma.path.a,
  skip = 4,
...
ma.path.b <- "data/input/ma/star-ratings/Extracted Star Ratings/2022/2022 Star Ratings Data Table - Summary Rating (Oct 06 2021).csv"
star.data.b <- fread(
  ma.path.b,
  skip = 2,
  stringsAsFactors=FALSE, 
