...
ma.path.a <- paste0("data/input/ma/landscape/Extracted Data/2021LandscapeSource file MA_AtoM 10152020.csv")
...
ma.path.b <- paste0("data/input/ma/landscape/Extracted Data/2021LandscapeSource file MA_NtoW 10152020.csv")
...
mapd.path.a <- paste0("data/input/ma/landscape/Extracted Data/PartCD/2021/Medicare Part D 2021 Plan Report 09082020.xls")
...
mapd.path.b <- paste0("data/input/ma/landscape/Extracted Data/PartCD/2021/Medicare Part D 2021 Plan Report 09082020.xls")
