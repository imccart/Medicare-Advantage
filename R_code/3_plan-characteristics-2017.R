...
ma.path.a <- paste0("data/input/landscape/Extracted Data/2017LandscapeSource file MA_AtoM 10182016.csv")
...
ma.path.b <- paste0("data/input/landscape/Extracted Data/2017LandscapeSource file MA_NtoW 10182016.csv")
...
mapd.path.a <- paste0("data/input/landscape/Extracted Data/PartCD/2017/Medicare Part D 2017 Plan Report 10182016.xls")
...
mapd.path.b <- paste0("data/input/landscape/Extracted Data/PartCD/2017/Medicare Part D 2017 Plan Report 10182016.xls")
