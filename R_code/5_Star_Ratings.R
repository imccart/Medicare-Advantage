...
star.data.2015a=fread(ma.path.2015a,skip=4,stringsAsFactors=FALSE,select=c(1:38),col.names=rating.vars.2015)
...
star.ratings=rbind.fill(star.data.2008, star.data.2009, star.data.2010, star.data.2011,
