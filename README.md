...
1. [Monthly Plan Enrollment Data](https://www.cms.gov/Research-Statistics-Data-and-Systems/Statistics-Trends-and-Reports/MCRAdvPartDEnrolData/Monthly-Enrollment-by-Contract-Plan-State-County.html)
   ...
   Stata .do file to organize CPSC enrollment data is available here: [1_Plan_Data.do](https://github.com/imccart/Medicare-Advantage/blob/main/stata_code/1_Plan_Data.do)
   
   R script to organize CPSC enrollment data is available here: [1_plan-data.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/1_plan-data.R)
...
2. [Service Area Files](https://www.cms.gov/Research-Statistics-Data-and-Systems/Statistics-Trends-and-Reports/MCRAdvPartDEnrolData/MA-Contract-Service-Area-by-State-County.html)
   ...
   Stata .do file to organize the service area files is available here: [2_Service_Areas.do](https://github.com/imccart/Medicare-Advantage/blob/main/stata_code/2_Service_Areas.do)

   R script to organize the service area files is available here: [2_service-area.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/2_service-area.R)
...
3. [Plan Characteristics](https://www.cms.gov/Medicare/Prescription-Drug-Coverage/PrescriptionDrugCovGenIn/index)
   ...
   Stata .do file to organize plan premiums and other characteristics is available here: [3_Plan_Characteristics.do](https://github.com/imccart/Medicare-Advantage/blob/main/stata_code/3_Plan_Characteristics.do)
   
   R scripts to organize plan premiums and other characteristics are available here. Due to slight differences in variables and file structures over time, I've created separate code files for each year of the data. Just change the year at the end of the file path for the correct code file, as needed: [3_plan-characteristics-2007.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/3_plan-characteristics-2007.R) through [3_plan-characteristics-2019.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/3_plan-characteristics-2019.R)
...
4. [Penetration Files](https://www.cms.gov/Research-Statistics-Data-and-Systems/Statistics-Trends-and-Reports/MCRAdvPartDEnrolData/MA-State-County-Penetration.html)
   ...
   Stata .do file to organize the penetration files is available here: [4_Penetration_Files.do](https://github.com/imccart/Medicare-Advantage/blob/main/stata_code/4_Penetration_Files.do)

   R script to organize the penetration files is available here: [4_penetration.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/4_penetration.R)
...
5. [Star Ratings](https://www.cms.gov/medicare/prescription-drug-coverage/prescriptiondrugcovgenin/performancedata.html)
   ...
   Stata .do file to organize the star ratings data is available here: [5_Star_Ratings.do](https://github.com/imccart/Medicare-Advantage/blob/main/stata_code/5_Star_Ratings.do)

   R scripts to organize the star ratings data are available here. Due to slight differences in variables and file structures over time, I've created separate code files for each year of the data. Just change the year at the end of the file path for the correct code file, as needed: [5_star-ratings-2008.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/5_star-ratings-2008.R) through [5_star-ratings-2019.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/5_star-ratings-2019.R)
...
6. [CMS Payment Data](https://www.cms.gov/Medicare/Medicare-Advantage/Plan-Payment/Plan-Payment-Data.html)
   ...
   [6_Risk_Rebates.do](https://github.com/imccart/Medicare-Advantage/blob/main/stata_code/6_Risk_Rebates.do)
   ...
   [6_risk-rebates-2006.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/6_risk-rebates-2006.R) through [6_risk-rebates-2019.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/6_risk-rebates-2019.R)
...
7. [MA Benchmark Rates](https://www.cms.gov/Medicare/Health-Plans/MedicareAdvtgSpecRateStats/Ratebooks-and-Supporting-Data.html)
   ...
   Stata .do file to organize the benchmark rates is available here: [7_MA_Benchmark.do](https://github.com/imccart/Medicare-Advantage/blob/main/stata_code/7_MA_Benchmark.do)

   R scripts to organize the benchmark rates are available here. Due to slight differences in variables and file structures over time, I've created separate code files for each year of the data. Just change the year at the end of the file path for the correct code file, as needed: [7_benchmarks-2007.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/7_benchmarks-2007.R) through [7_benchmarks-2019.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/7_benchmarks-2019.R)
...
8. [CMS Fee-for-service Costs](https://www.cms.gov/Medicare/Health-Plans/MedicareAdvtgSpecRateStats/FFS-Data.html)
   ...
   [8_FFS_Costs.do](https://github.com/imccart/Medicare-Advantage/blob/main/stata_code/8_FFS_Costs.do)
   ...
   [8_ffs-costs-2007.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/8_ffs-costs-2007.R) through [8_ffs-costs-2019.R](https://github.com/imccart/Medicare-Advantage/blob/main/R_code/8_ffs-costs-2019.R).